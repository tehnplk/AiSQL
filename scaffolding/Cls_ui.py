...
class Cls_ui(object):
    ...
    def setupUi(self,Cls_ui):
        """
        Set up the user interface for Visit management.
        """
        # Set window properties
        Cls_ui.setWindowTitle("Visit Management")
        Cls_ui.resize(1000, 700)

        # Create main layout
        self.main_layout = QVBoxLayout(Cls_ui)
        self.main_layout.setContentsMargins(20, 20, 20, 20)
        self.main_layout.setSpacing(15)

        # Create title label
        self.title_label = QLabel("Visit Management System", Cls_ui)
        ...
        self.add_button = QPushButton("Add Visit", Cls_ui)
        ...
        self.edit_button = QPushButton("Edit Visit", Cls_ui)
        ...
        self.delete_button = QPushButton("Delete Visit", Cls_ui)
        ...
        self.refresh_button = QPushButton("Refresh", Cls_ui)
        ...
        # Create table view
        self.visit_table = QTableView(Cls_ui)
